...
import { DemoPromptTemplateService } from '@/server/services/demo-prompt-template.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ code: 200, message: 'success', data: DemoPromptTemplateService.list() });
  } catch (error: any) {
