...
// ── Web Push (VAPID) setup ──────────────────────────────────
{
  ...
  if (!vapidPublic || !vapidPrivate) {
    ...
    console.log("Generated and saved VAPID keys to ./.claudeck-data/.env");
  }
...
// Serve user plugins from ./.claudeck-data/plugins/
...
app.get("/api/plugins", (req, res) => {
  ...
  // 2. User plugins from ./.claudeck-data/plugins/
...
\x1b[2m  Browser UI for Claude Code\x1b[0m
  ...
  \x1b[2m➜  Data:\x1b[0m    ./.claudeck-data/
